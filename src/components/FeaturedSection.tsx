...
const FeaturedSection = () => {
    const featuredCourses = coursesData.courses.filter(
        (course: FeaturedSectionProps) => course.isFeatured
    );
    return (
            ...
            <div>
                ...
                <div className="mt-10 mx-8">
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-center">
                        {featuredCourses.map((course: FeaturedSectionProps) => (
                            <div key={course.id} className="text-center">
                                <BackgroundGradient
                                    className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden max-w-sm"
